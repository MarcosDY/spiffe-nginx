...
ngx_int_t ngx_ssl_spiffe_id_verification(ngx_conf_t *cf, ngx_ssl_t *ssl, 
    ngx_array_t *accepted);
...
ngx_int_t ngx_ssl_check_spiffe_id(ngx_connection_t *c, ngx_array_t *accepted);
